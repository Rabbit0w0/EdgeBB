...
<?php Edge_Plugin::factory('admin/write-js.php')->write(); ?>
...
$(document).ready(function() {
    ...
    // text 自动拉伸
    Edge.editorResize('text', '<?php $security->index('/action/ajax?do=editorResize'); ?>');
...
<?php endif; ?>
    ...
    $('#edit-secondary .edge-option-tabs li').click(function() {
        $('#edit-secondary .edge-option-tabs li').removeClass('active');
