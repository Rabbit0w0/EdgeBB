...
Edge_Widget::widget('Widget_Contents_Attachment_Edit')->to($attachment);
?>
		...
		<div class="card">
		  <div class="card-body" role="main">
			...
			<div class="col-mb-12 col-tb-8" role="main">
				...
				<p><img src="<?php $attachment->attachment->url(); ?>" alt="<?php $attachment->attachment->name(); ?>" class="edge-attachment-photo" /></p>
				<?php endif; ?>
				
				<p>
					<?php $mime = Edge_Common::mimeIconType($attachment->attachment->mime); ?>
