  ...
  <div class="col-md-9 grid-margin stretch-card" role="main">
	<div class="card">
	  <div class="card-body">
		...
		<?php Edge_Plugin::factory('admin/write-page.php')->content($page); ?>
	  </div>
	</div>
  </div>
	...
	<div class="card">
	  <div class="card-body">
		...
		<div id="tab-advance" class="tab-content">
			...
			<?php Edge_Plugin::factory('admin/write-page.php')->option($page); ?>
			...
			<div id="advance-panel">
				...
				<?php Edge_Plugin::factory('admin/write-page.php')->advanceOption($page); ?>
			</div>
			<?php if($page->have()): ?>
...
Edge_Plugin::factory('admin/write-page.php')->trigger($plugged)->richEditor($page);
if (!$plugged) {
    include 'editor-js.php';
}
include 'file-upload-js.php';
include 'custom-fields-js.php';
Edge_Plugin::factory('admin/write-page.php')->bottom($page);
include 'footer.php';
?>
