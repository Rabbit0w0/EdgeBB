...
<!-- BAE -->
    ...
    <li>
        <label class="edge-label" for="dbUser"><?php _e('应用API Key'); ?></label>
    ...
    <li>
        <label class="edge-label" for="dbPassword"><?php _e('应用Secret Key'); ?></label>
    ...
    <li>
        <label class="edge-label" for="dbDatabase"><?php _e('数据库名'); ?></label>
...
<?php if (0 === strpos($adapter, 'Pdo_')): ?>
    <li>
        <label class="edge-label" for="dbHost"><?php _e('数据库实例名'); ?></label>
        <input type="text" class="text" name="dbHost" id="dbHost" value="<?php _v('dbHost'); ?>"/>
        <p class="description"><?php _e('请填入您在Cloud SQL面板中创建的数据库实例名称, 示例: %s', '<em class="warning">/cloudsql/edge-gae:edge</em>'); ?></p>
    </li>
<?php else: ?>
    <li>
        <label class="edge-label" for="dbHost"><?php _e('数据库实例名'); ?></label>
...
<?php endif; ?>
    ...
    <li>
        <label class="edge-label" for="dbUser"><?php _e('数据库用户名'); ?></label>
        <input type="text" class="text" name="dbUser" id="dbUser" value="<?php _v('dbUser'); ?>" />
    </li>
    <li>
        <label class="edge-label" for="dbPassword"><?php _e('数据库密码'); ?></label>
        <input type="password" class="text" name="dbPassword" id="dbPassword" value="<?php _v('dbPassword'); ?>" />
    </li>
    <li>
        <label class="edge-label" for="dbDatabase"><?php _e('数据库名'); ?></label>
        <input type="text" class="text" name="dbDatabase" id="dbDatabase" value="<?php _v('dbDatabase', 'edge'); ?>" />
...
<?php  else: ?>
    <li>
        <label class="edge-label" for="dbHost"><?php _e('数据库地址'); ?></label>
    ...
    <li>
        <label class="edge-label" for="dbPort"><?php _e('数据库端口'); ?></label>
...
<input type="hidden" name="dbCharset" value="<?php _e('utf8'); ?>" />
    ...
    <li>
        <label class="edge-label" for="dbCharset"><?php _e('数据库编码'); ?></label>
    ...
    <li>
        <label class="edge-label" for="dbEngine"><?php _e('数据库引擎'); ?></label>
