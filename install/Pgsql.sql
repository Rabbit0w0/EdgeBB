--
-- Table structure for table "edge_comments"
--
CREATE SEQUENCE "edge_comments_seq";

CREATE TABLE "edge_comments" (  "coid" INT NOT NULL DEFAULT nextval('edge_comments_seq'),
...
--
-- Table structure for table "edge_contents"
--

CREATE SEQUENCE "edge_contents_seq";

CREATE TABLE "edge_contents" (  "cid" INT NOT NULL DEFAULT nextval('edge_contents_seq'),
...
--
-- Table structure for table "edge_fields"
--

CREATE TABLE "edge_fields" ("cid" INT NOT NULL,
...
--
-- Table structure for table "edge_metas"
--

CREATE SEQUENCE "edge_metas_seq";

CREATE TABLE "edge_metas" (  "mid" INT NOT NULL DEFAULT nextval('edge_metas_seq'),
...
--
-- Table structure for table "edge_options"
--

CREATE TABLE "edge_options" (  "name" VARCHAR(32) NOT NULL DEFAULT '',
...
--
-- Table structure for table "edge_relationships"
--

CREATE TABLE "edge_relationships" (  "cid" INT NOT NULL DEFAULT '0',
...
--
CREATE SEQUENCE "edge_users_seq";

CREATE TABLE "edge_users" (  "uid" INT NOT NULL DEFAULT nextval('edge_users_seq') ,
