...
try {
    ...
    if (Edge_Db_Adapter_Mysql::isAvailable()) {
        $wordpressDb = new Edge_Db('Mysql', $dbConfig->prefix);
    } else {
        $wordpressDb = new Edge_Db('Pdo_Mysql', $dbConfig->prefix);
    }
...
<div class="main">
    <div class="body container">
        ...
        <div class="colgroup edge-page-main" role="main">
            <div class="com-mb-12">
                <?php if ($success): ?>
                <div class="message notice">
                <form action="<?php $options->index('/action/wordpress-to-edge'); ?>" method="post">
                ...
                <div class="message error">
                    ...
                    Edge_Common::url('options-plugin.php?config=WordpressToEdge', $options->adminUrl)); ?>
                </div>
                <?php endif; ?>
            </div>
        </div>
