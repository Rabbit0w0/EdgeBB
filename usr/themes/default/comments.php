    ...
    <div class="comments-header" id="<?php $this->respondId(); ?>" >
        ...
        <?php if($this->allow('comment')): ?>
          <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
            <img id="comment-loading" src="https://cdn.jsdelivr.net/gh/youranreus/R@v1.0.3/G/image/loading.gif"></img>
            <div class="cancel-comment-reply clear">
              ...
              <?php endif; ?>
              <p>
                  <input name="_" type="hidden" id="comment_" value="<?php echo Helper::security()->getToken(str_replace(array('?_pjax=%23pjax-container', '&_pjax=%23pjax-container'), '', Edge_Request::getInstance()->getRequestUrl()));?>"/>
