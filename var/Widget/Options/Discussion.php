...
class Widget_Options_Discussion extends Widget_Abstract_Options implements Widget_Interface_Do
{
    ...
    {
        /** 构建表格 */
        $form = new Edge_Widget_Helper_Form($this->security->getIndex('/action/options-discussion'),
        Edge_Widget_Helper_Form::POST_METHOD);

        /** 评论日期格式 */
        $commentDateFormat = new Edge_Widget_Helper_Form_Element_Text('commentDateFormat', NULL, $this->options->commentDateFormat,
        ...
        /** 评论列表数目 */
        $commentsListSize = new Edge_Widget_Helper_Form_Element_Text('commentsListSize', NULL, $this->options->commentsListSize,
        ...
        $commentsShow = new Edge_Widget_Helper_Form_Element_Checkbox('commentsShow', $commentsShowOptions,
        ...
        $commentsPost = new Edge_Widget_Helper_Form_Element_Checkbox('commentsPost', $commentsPostOptions,
        $commentsPostOptionsValue, _t('评论提交'));
        $form->addInput($commentsPost->multiMode());

        /** 允许使用的HTML标签和属性 */
        $commentsHTMLTagAllowed = new Edge_Widget_Helper_Form_Element_Textarea('commentsHTMLTagAllowed', NULL,
