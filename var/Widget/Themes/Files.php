 ...
 * @license MIT License
 */
class Widget_Themes_Files extends Edge_Widget
{
    /**
     * 当前风格
     *
    ...
    public function execute()
    {
        ...
        throw new Edge_Widget_Exception('风格文件不存在', 404);
    }
    ...
    public function currentIsWriteable()
    {
        return is_writeable($this->widget('Widget_Options')
            ->themeFile($this->_currentTheme, $this->_currentFile)) && !Edge_Common::isAppEngine()
        && (!defined('__EDGE_THEME_WRITEABLE__') || __EDGE_THEME_WRITEABLE__);
    }
