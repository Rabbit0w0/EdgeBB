 ...
 * @license MIT License
 */
class Widget_Themes_List extends Edge_Widget
{
    /**
     * @return array
     */
    ...
    {
        return glob(__EDGE_ROOT_DIR__ . __EDGE_THEME_DIR__ . '/*', GLOB_ONLYDIR);
    }
        ...
        if ($themes) {
            ...
            foreach ($themes as $key => $theme) {
                ...
                if (file_exists($themeFile)) {
                    $info = Edge_Plugin::parseInfo($themeFile);
                    ...
                    if ($screen) {
                        ...
                        $info['screen'] = Edge_Common::url('noscreen.png', $options->adminStaticUrl('img'));
                    }
