 ...
 * @package Widget
 */
abstract class Edge_Widget_Helper_PageNavigator
{
    /**
     * 记录总数
     *
    ...
    public function __construct($total, $currentPage, $pageSize, $pageTemplate)
    {
        ...
        if (($currentPage > $this->_totalPage || $currentPage < 1) && $total > 0) {
            throw new Edge_Widget_Exception('Page Not Exists', 404);
        }
    }
    ...
    {
        throw new Edge_Widget_Exception(get_class($this) . ':' . __METHOD__, 500);
    }
}
