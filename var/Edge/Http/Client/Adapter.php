 ...
 * @package Http
 */
abstract class Edge_Http_Client_Adapter
{
    /**
     * 方法名
     *
     ...
     * @var string
     */
    protected $method = Edge_Http_Client::METHOD_GET;
    ...
    {
        $this->data = $data;
        $this->setMethod(Edge_Http_Client::METHOD_POST);
        return $this;
    }
     ...
     * @return string
     * @throws Edge_Http_Client_Exception
     */
    public function send($url)
    {
        ...
        if (!empty($params['host'])) {
            ...
            throw new Edge_Http_Client_Exception('Unknown Host', 500);
        }

        if (!in_array($params['scheme'], array('http', 'https'))) {
            throw new Edge_Http_Client_Exception('Unknown Scheme', 500);
        }
        ...
        $url = Edge_Common::buildUrl($params);
