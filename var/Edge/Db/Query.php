 ...
 * Edge数据库查询语句构建类
 * 使用方法:
 * $query = new Edge_Db_Query();	//或者使用DB积累的sql方法返回实例化对象
...
class Edge_Db_Query
{
     ...
     * 构造函数,引用数据库适配器作为内部数据
     *
     * @param Edge_Db_Adapter $adapter 数据库适配器
     * @param string $prefix 前缀
     */
    public function __construct(Edge_Db_Adapter $adapter, $prefix)
    {
     ...
     * @return Edge_Db_Query
     */
    public function join($table, $condition, $op = Edge_Db::INNER_JOIN)
    {
     ...
     * @return Edge_Db_Query
     */
    public function order($orderby, $sort = Edge_Db::SORT_ASC)
    {
    ...
    {
        $this->_sqlPreBuild['action'] = Edge_Db::SELECT;
        $args = func_get_args();
    ...
    {
        $this->_sqlPreBuild['action'] = Edge_Db::UPDATE;
        $this->_sqlPreBuild['table'] = $this->filterPrefix($table);
        return $this;
    }
    ...
    {
        $this->_sqlPreBuild['action'] = Edge_Db::DELETE;
        $this->_sqlPreBuild['table'] = $this->filterPrefix($table);
        return $this;
    }
    ...
    {
        $this->_sqlPreBuild['action'] = Edge_Db::INSERT;
        $this->_sqlPreBuild['table'] = $this->filterPrefix($table);
        return $this;
    }
