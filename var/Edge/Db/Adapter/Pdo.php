 ...
 * @package Db
 */
abstract class Edge_Db_Adapter_Pdo implements Edge_Db_Adapter
{
    /**
     * 数据库对象
     *
    ...
    public function connect(Edge_Config $config)
    {
        try {
            ...
            /** 数据库异常 */
            throw new Edge_Db_Adapter_Exception($e->getMessage());
        }
    }
     ...
     * @return PDO
     */
    abstract public function init(Edge_Config $config);
    ...
    public function query($query, $handle, $op = Edge_Db::READ, $action = NULL, $table = NULL)
    {
        try {
            ...
            /** 数据库异常 */
            throw new Edge_Db_Query_Exception($e->getMessage(), $e->getCode());
        }
