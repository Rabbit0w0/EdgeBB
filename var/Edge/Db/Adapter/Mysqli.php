 ...
 * @package Db
 */
class Edge_Db_Adapter_Mysqli implements Edge_Db_Adapter
{
    /**
     * 数据库连接字符串标示
     *
    ...
    public function connect(Edge_Config $config)
    {
        ...
        /** 数据库异常 */
        throw new Edge_Db_Adapter_Exception(@$this->_dbLink->error);
    }
    ...
    public function query($query, $handle, $op = Edge_Db::READ, $action = NULL, $table = NULL)
    {
        ...
        /** 数据库异常 */
        throw new Edge_Db_Query_Exception($this->_dbLink->error, $this->_dbLink->errno);
    }
