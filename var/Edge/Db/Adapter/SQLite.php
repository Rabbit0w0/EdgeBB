 ...
 * @package Db
 */
class Edge_Db_Adapter_SQLite implements Edge_Db_Adapter
{
    /**
     * 数据库标示
     *
     ...
     * @return resource
     */
    public function connect(Edge_Config $config)
    {
        ...
        /** 数据库异常 */
        throw new Edge_Db_Adapter_Exception($error);
    }
     ...
     * @throws Edge_Db_Query_Exception
     */
    public function query($query, $handle, $op = Edge_Db::READ, $action = NULL, $table = NULL)
    {
        ...
        throw new Edge_Db_Query_Exception(sqlite_error_string($errorCode), $errorCode);
    }
    ...
    {
        return Edge_Common::filterSQLite2ColumnName(sqlite_fetch_array($resource, SQLITE_ASSOC));
    }
    ...
    public function parseSelect(array $sql)
    {
        ...
        return Edge_Common::filterSQLite2CountQuery('SELECT ' . $sql['fields'] . ' FROM ' . $sql['table'] .
