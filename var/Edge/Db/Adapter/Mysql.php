 ...
 * @package Db
 */
class Edge_Db_Adapter_Mysql implements Edge_Db_Adapter
{
    /**
     * 数据库连接字符串标示
     *
    ...
    public function connect(Edge_Config $config)
    {
        ...
        /** 数据库异常 */
        throw new Edge_Db_Adapter_Exception(@mysql_error($this->_dbLink));
    }
    ...
    public function query($query, $handle, $op = Edge_Db::READ, $action = NULL, $table = NULL)
    {
        ...
        /** 数据库异常 */
        throw new Edge_Db_Query_Exception(@mysql_error($this->_dbLink), mysql_errno($this->_dbLink));
    }
