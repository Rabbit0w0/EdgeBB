...
Edge_Widget::widget('Widget_Metas_Tag_Admin')->to($tags);
?>
...
<div class="row">
	  ...
	  <div class="card-body">
		...
		<div class="dropdown-divider"></div>
		  <form method="post" name="manage_tags" class="operate-form">
			...
			<ul class="edge-list-notable tag-list clearfix">
				<?php if($tags->have()): ?>
				<?php while ($tags->next()): ?>
				...
				<?php endwhile; ?>
				<?php else: ?>
				<h6 class="edge-list-table-title"><?php _e('没有任何标签'); ?></h6>
				<?php endif; ?>
			</ul>
  ...
  <div class="col-md-5 grid-margin stretch-card" role="form">
	<div class="card">
	  <div class="card-body">
		<?php Edge_Widget::widget('Widget_Metas_Tag_Edit')->form()->render(); ?>
	  </div>
	</div>
  </div>
</div>
...
(function () {
    $(document).ready(function () {
        ...
        $('.edge-list-notable').tableSelectable({
