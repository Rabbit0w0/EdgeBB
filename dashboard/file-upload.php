...
if (isset($post) || isset($page)) {
    ...
    if ($cid) {
        Edge_Widget::widget('Widget_Contents_Attachment_Related', 'parentId=' . $cid)->to($attachment);
    } else {
        Edge_Widget::widget('Widget_Contents_Attachment_Unattached')->to($attachment);
    }
}
?>
