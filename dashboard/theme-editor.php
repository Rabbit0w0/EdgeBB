...
Edge_Widget::widget('Widget_Themes_Files')->to($files);
?>


<div class="row">
	<div class="col-md-12 grid-margin">
		<div class="card edge-page-main" role="main">
		  <div class="card-body">
...
Edge_Plugin::factory('dashboard/theme-editor.php')->bottom($files);
include 'footer.php';
?>
