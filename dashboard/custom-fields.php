...
<section id="custom-field" class="edge-post-option<?php if (empty($defaultFields) && empty($fields)): ?> fold<?php endif; ?>">
	<label id="custom-field-expand" class="edge-label"><a href="##"><i class="i-caret-right"></i> <?php _e('自定义字段'); ?></a></label>
	<table class="edge-list-table mono">
		<colgroup>
			<col width="25%"/>
			<col width="10%"/>
			<col width="55%"/>
	...
	<div class="description clearfix">
		...
		<?php _e('自定义字段可以扩展你的模板功能, 使用方法请跳转至 Edge <a href="http://docs.typecho.org/help/custom-fields">帮助文档</a>'); ?>
	</div>
</section>
