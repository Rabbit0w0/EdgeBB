...
$(document).ready(function () {
    ...
    <?php Edge_Plugin::factory('dashboard/editor-js.php')->markdownEditor($content); ?>
    ...
    var input = $('#text'), th = textarea.height(), ph = preview.height(),
        uploadBtn = $('<button type="button" id="btn-fullscreen-upload" class="btn btn-link">'
            ...
            .click(function() {
                $('a', $('.edge-option-tabs li').not('.active')).trigger('click');
                return false;
            });

    $('.edge-option-tabs li').click(function () {
    ...
    function initMarkdown() {
        ...
        Edge.uploadComplete = function (file) {
            Edge.insertFileToEditor(file.title, file.url, file.isImage);
        };
