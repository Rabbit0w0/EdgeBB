...
<?php Edge_Widget::widget('Widget_Contents_Attachment_Admin')->to($attachments); ?>
					...
					<div class="table-responsive">
						<table class="table edge-list-table">
							...
							<tbody>
								...
								<?php $mime = Edge_Common::mimeIconType($attachments->attachment->mime); ?>
								<tr id="<?php $attachments->theId(); ?>">
									<td><input type="checkbox" value="<?php $attachments->cid(); ?>" name="cid[]"/></td>
									<td><a href="<?php $options->adminUrl('manage-comments.php?cid=' . $attachments->cid); ?>" class="balloon-button size-<?php echo Edge_Common::splitByCount($attachments->commentsNum, 1, 10, 20, 50, 100); ?>"><?php $attachments->commentsNum(); ?></a></td>
									<td>
								...
								<?php else: ?>
								<tr>
									<td colspan="6"><h6 class="edge-list-table-title"><?php _e('没有任何文件'); ?></h6></td>
								</tr>
								<?php endif; ?>
							</tbody>
