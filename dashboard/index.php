  ...
  <div class="mdui-col-xs-4">
	<div class="card bg-gradient-info card-img-holder text-white">
	  <div class="card-body">
		...
		<h6 class="card-text">
			<?php if($user->pass('contributor', true)): ?>
			<?php if($user->pass('editor', true) && 'on' == $request->get('__edge_all_comments') && $stat->waitingCommentsNum > 0): ?>
			...
			<?php endif; ?>
			<?php if($user->pass('editor', true) && 'on' == $request->get('__edge_all_comments') && $stat->spamCommentsNum > 0): ?>
  ...
  <div class="col-md-6 grid-margin stretch-card">
	<div class="card">
	  <div class="card-body">
		...
		<ul class="mdui-list">
			<?php Edge_Widget::widget('Widget_Contents_Post_Recent', 'pageSize=10')->to($posts); ?>
			<?php if($posts->have()): ?>
	  ...
	  <div class="card-body">
		...
		<div class="table-responsive">
		  <table class="table">
			...
			<?php Edge_Widget::widget('Widget_Comments_Recent', 'pageSize=10')->to($comments); ?>
