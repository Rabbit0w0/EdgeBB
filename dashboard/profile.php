					...
					<div class="default-tab" role="form">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade show active" id="profile" role="tabpanel">
								<div class="p-t-15">
									<?php Edge_Widget::widget('Widget_Users_Profile')->profileForm()->render(); ?>
								</div>
							</div>
							...
							<div class="tab-pane fade" id="write_set">
								...
								<section id="writing-option">
									<?php Edge_Widget::widget('Widget_Users_Profile')->optionsForm()->render(); ?>
								</section>
								<?php endif; ?>
								</div>
							</div>
							...
							<div class="tab-pane fade" id="password">
								...
								<section id="change-password">
									<?php Edge_Widget::widget('Widget_Users_Profile')->passwordForm()->render(); ?>
								</section>
								<?php Edge_Widget::widget('Widget_Users_Profile')->personalFormList(); ?>
								</div>
							</div>
						</div>
					</div>
...
include 'form-js.php';
Edge_Plugin::factory('dashboard/profile.php')->bottom();
include 'footer.php';
?>
