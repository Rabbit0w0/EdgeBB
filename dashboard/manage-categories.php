...
Edge_Widget::widget('Widget_Metas_Category_Admin')->to($categories);
?>
			...
			<form method="post" name="manage_categories" class="operate-form">
				...
				<tbody>
					...
					<tr id="mid-<?php $categories->theId(); ?>">
						...
						<td><a class="balloon-button left size-<?php echo Edge_Common::splitByCount($categories->count, 1, 10, 20, 50, 100); ?>" href="<?php $options->adminUrl('manage-posts.php?category=' . $categories->mid); ?>"><?php $categories->count(); ?></a></td>
					</tr>
					<?php endwhile; ?>
					<?php else: ?>
					<tr>
						<td colspan="6"><h6 class="edge-list-table-title"><?php _e('没有任何分类'); ?></h6></td>
					</tr>
					<?php endif; ?>
				</tbody>
					</table>
...
(function () {
    $(document).ready(function () {
        ...
        $('.edge-mini-panel').effect('highlight', '#AACB36');
        <?php endif; ?>
    });
})();
</script>
